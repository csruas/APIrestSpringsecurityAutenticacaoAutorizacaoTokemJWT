...
import med.voll.api.MedicoDTO.DadosDetalhamentoMedico;
...
public class MedicoController {
    ...
    @GetMapping
    public ResponseEntity<org.springframework.data.domain.Page<DadosListagemMedico>> listar(@PageableDefault(size = 10, sort = {"nome"}) Pageable paginacao) {
